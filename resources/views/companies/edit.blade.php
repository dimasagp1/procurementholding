                    ...
                    <form method="POST" action="{{ route('companies.update', $company) }}">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $company->code) }}" required maxlength="10">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check mt-4">
                                    ...
                                    <input class="form-check-input" type="checkbox" value="1" id="is_active" name="is_active" {{ old('is_active', $company->is_active) ? 'checked' : '' }}>
                        ...
                        <div id="odoo-section" style="{{ old('connect_odoo', $company->connect_odoo) ? '' : 'display:none;' }}" class="mt-3">
                            ...
                            <p class="text-muted small mb-3">Configure unique Odoo credentials for this company.</p>
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                        ...
                        <div id="finance-section" style="{{ old('connect_finance', $company->connect_finance) ? '' : 'display:none;' }}" class="mt-3">
                            ...
                            <p class="text-muted small mb-3">Configure unique Finance API parameters for this company.</p>
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
