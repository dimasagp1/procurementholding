...
<div id="global-loading-overlay" class="active">
    <div class="luxury-loader-container">
        ...
        <div class="luxury-meta">
            <div class="brand-badge">PROCUREMENT SYSTEM</div>
            <h3 class="luxury-title loader-title">MEMUAT DATA ANGGARAN</h3>
            ...
            <!-- Elegant Description -->
            <p class="luxury-desc loader-desc">Mengamankan pagu anggaran...</p>
        </div>
    </div>
</div>
...
<script>
    ...
    const procurementDescs = [
        "Mengamankan pagu anggaran...",
        "Memuat rincian Purchase Request...",
        "Mengalkulasi estimasi harga barang...",
        "Memeriksa otorisasi approval PR...",
        "Menghubungkan integrasi data Odoo...",
        "Sinkronisasi database vendor...",
        "Memuat daftar staging pagu pengeluaran..."
    ];
    ...
    window.showGlobalLoading = function(title, desc) {
        ...
        if (overlay) {
            ...
            if (descEl) descEl.textContent = desc || procurementDescs[0];
            ...
            descInterval = setInterval(() => {
                if (descEl && !desc) {
                    ...
                    setTimeout(() => {
                        descEl.textContent = procurementDescs[descIndex];
                        descEl.style.opacity = '1';
                        descIndex = (descIndex + 1) % procurementDescs.length;
                    }, 300);
                }
            }, 2500);
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Intercept programmatic submits
        ...
        document.addEventListener('click', function(e) {
            ...
            window.showGlobalLoading(title, 'Mengunduh data transaksi terenkripsi...');
        });
    });
